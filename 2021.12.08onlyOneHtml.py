...
fileByteList = ['.png', '.jpg', '.mp3', '.ttf', '.plist', 'txt','.bin','.mp4','.mpeg']
...
def read_in_chunks(filePath):
    ...
    if extName in fileByteList:
        if extName == ".mp4" or extName == ".mpeg":
            a = convert2base64(filePath,'data:video/mp4;base64,')
            # print(a)
            return a
            # return None
        else :
            ...
            if base64Prefix != None:
                ...
                return base64Str
        # file_object = open(filePath, 'rb')
        # # base64Str = bytes(base64.b64encode(file_object.read()), encoding='utf-8')
        # base64Str = base64.b64encode(file_object.read())
        # base64Prefix = base64PrefixList[extName]
        # if base64Prefix != None:
        #     base64Str = bytes(base64Prefix, 'utf-8') + base64Str
